...
class Pagar saldo parcial extends TWindow
{
    protected $form;
    private $formFields = [];
    ...
    public function __construct( $param )
    {
        ...
        $row1 = $this->form->addFields([new TLabel("INFORMAÇÃO:", null, '14px', 'B')],[new TLabel("O DREX tokenizado será enviado da carteira do FIADOR para o contrato que passa a funcionar como uma conta ESCROW, a ação do contrato deve ser disparada unicamente pelo agente fiador, mas se tratando do MVP e disparo do contrato, fica a carga da aplicação simular esta operação.", null, '14px', null)]);
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            new TMessage('info',$object->apagar);
            exit;
            ...
            $result=  $w3->PagarDebito($object->Dbfiador->cchaveprivada,

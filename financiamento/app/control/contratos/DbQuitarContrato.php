...
class DbQuitarContrato extends TWindow
{
    protected $form;
    private $formFields = [];
    ...
    public function __construct( $param )
    {
        ...
        $row1 = $this->form->addFields([new TLabel("INFORMAÇÃO:", null, '14px', 'B')],[new TLabel("A quitação de contrato pode ser parcial, ela entrega o valor do Drex tokenizado para o FINANCIADOR e abate a parcialidade da divida ou a totalidade dela.", null, '14px', null)]);
        ...
        $row6 = $this->form->addFields([new TLabel("Valor a ser pago(Drex tokenizado):", null, '14px', null)],[$apagar],[],[]);
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            $result=  $w3->PagarDebitoFiador($object->Dbcontrato->cchaveprivada,

...
class DbEnviarDrexTokenizado extends TWindow
{
    protected $form;
    private $formFields = [];
    ...
    public function __construct( $param )
    {
        ...
        parent::setTitle("Envio de Drex Tokenizado");
        ...
        $this->form->setFormTitle("Envio de Drex Tokenizado");
        ...
        $btn_onsave = $this->form->addAction("Enviar Drex Tokenizado", new TAction([$this, 'onSave']), 'fas:save #ffffff');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            $result=  $w3->EnviarDrexTokenizado($object->Dbfiador->cchaveprivada,
            ...
            $it->ctipo='EnvioDeDrexTokenizado';
            $it->nbloco=$result[1];

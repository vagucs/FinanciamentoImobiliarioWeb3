...
class DbPargarParcial extends TWindow
{
    protected $form;
    private $formFields = [];
    ...
    public function __construct( $param )
    {
        ...
        parent::setTitle("Pagamento de parcela");
        ...
        $this->form->setFormTitle("Pagamento de parcela");
        ...
        $row1 = $this->form->addFields([new TLabel("INFORMAÇÃO:", null, '14px', 'B')],[new TLabel("O Drex do pagamento será enviado da carteira do comprador para  a carteira do agente financiador, o saldo do debito será abatido no contrato e o saldo drex inicialmente depositado, assim como a divida total corrente do contrato.", null, '14px', null)]);
        ...
        $row6 = $this->form->addFields([new TLabel("Valor a ser pago(Drex):", null, '14px', null)],[$apagar],[],[]);

        // create the form actions
        $btn_onsave = $this->form->addAction("Pagar parcela", new TAction([$this, 'onSave']), 'fas:save #ffffff');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            $result=  $w3->PagarDebito($object->Dbcomprador->cchaveprivada,

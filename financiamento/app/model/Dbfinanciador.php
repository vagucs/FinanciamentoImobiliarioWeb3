...
class Dbfinanciador extends TRecord
{
    const TABLENAME  = 'dbfinanciador';
    const PRIMARYKEY = 'id';
    ...
    public function getDbfinanciamentoss()
    {
        ...
        $criteria->add(new TFilter('dbfinanciador_id', '=', $this->id));
    ...
    public function get_dbfinanciamentos_dbcontrato_to_string()
    {
        ...
        $values = Dbfinanciamentos::where('dbfinanciador_id', '=', $this->id)->getIndexedArray('dbcontrato_id','{dbcontrato->cnome}');
    ...
    public function get_dbfinanciamentos_dbfinanciador_to_string()
    {
        ...
        $values = Dbfinanciamentos::where('dbfinanciador_id', '=', $this->id)->getIndexedArray('dbfinanciador_id','{dbfinanciador->cnome}');
        return implode(', ', $values);
    }
    ...
    public function get_dbfinanciamentos_dbfiador_to_string()
    {
        ...
        $values = Dbfinanciamentos::where('dbfinanciador_id', '=', $this->id)->getIndexedArray('dbfiador_id','{dbfiador->cnome}');
        return implode(', ', $values);
    }
    ...
    public function get_dbfinanciamentos_dbcomprador_to_string()
    {
        ...
        $values = Dbfinanciamentos::where('dbfinanciador_id', '=', $this->id)->getIndexedArray('dbcomprador_id','{dbcomprador->cnome}');
        return implode(', ', $values);
    }
